...
<title>Tanveer Designer</title>
    ...
    <link rel="shortcut icon" href="images/Tanveer designer.png" type="image/x-icon">
    <!-- GOOGLE FONT -->
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul>
                                <li><a href="#">Contact: India:Punjab:Ludhiana</a>
                                </li>
                                <li><a href="#">Phone:+91-7814813900</a>
                                </li>
                            </ul>
                        </div>
                        <div class="ed-com-t1-right">
                            <ul>
                                <li><a href="#!" data-toggle="modal" data-target="#modal1"> </a>
                                </li>
                                <li><a href="#!" data-toggle="modal" data-target="#modal2"> </a>
                                </li>
                            </ul>
                        </div>
                        <div class="ed-com-t1-social">
                        <ul>
                                <li><a href="https://www.facebook.com/profile.php?id=100033375587252"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                </li>
                                <li><a href="https://www.instagram.com/loaab_shine/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <li><a href="ourteam.php">Ourteam</a>
                                </li>
                                <li><a href="VFX.php">Video</a>
                                </li>
        ...
        <div class="container com-sp pad-bot-70">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_2.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_3.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_4.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_9.png" alt="">
                        </a>
                    </div>
                </div><div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_6.png" alt="">
                        </a>
                    </div>
                </div><div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_7.png" alt="">
                        </a>
                    </div>
                </div><div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_8.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_10.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_11.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_12.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay">
                            <img src="images/Gallery/Logo_15.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row wed-foot-link-1">
            <div class="col-md-4 foot-tc-mar-t-o">
                <h4>Get In Touch</h4>
                <p>Address: Kuldeep Nagar Basti Mani Singh St No.3 Ludhiana Punjab 141007</p>
                <p>Phone: <a href="#!">+91-7814813900</a></p>
                <p>Email: <a href="#!">loaabshine786@gmail.com</a></p>
            </div>
            <div class="col-md-4">
